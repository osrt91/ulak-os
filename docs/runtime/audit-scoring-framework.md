...
## Worked example — scanner-project.com baseline

Scores at scanner-project's Sprint 0 (the director audit baseline):
...
Authoritative as of Ulak OS **v2.1.3**. Evidence base: scanner-project.com `_project_audit/00_master_index/methodology.md:107-161` and `final-executive-report.md:22-52`.
