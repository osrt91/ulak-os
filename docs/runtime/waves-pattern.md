...
The Waves pattern is the formal answer: **parallel within a Wave, serial between Waves**. It was improvised during the Sprint 0+1 session (2026-04-11, FP-02) and is now documented as a first-class runtime contract.
