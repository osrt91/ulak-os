...
The Strangler Fig protocol gave audit a 70% conflict reduction by enforcing a merge order: **infrastructure → backend → frontend → tests**. This doc generalizes that rule.
...
Authoritative as of Ulak OS **v2.1.3**. md:250-305` and `orchestrator-rules.md:109-130`.
