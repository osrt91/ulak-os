...
| **Rule packs** | 15 | [`docs/runtime/rule-packs/`](./docs/runtime/rule-packs/) — typescript-nextjs, python-fastapi, docker-compose, api-security, turkish-locale, localization-ssot, llm-streaming-context-aware, react-native-expo, flutter-ios-2026, multi-locale-eleven-rtl, kvkk-gdpr-compliance, async-python-fastapi, ai-generated-content-hygiene, i18n-routing-discipline, security-primitive-fail-closed |
...
| **Anti-patterns** | ~100 | 49 AP-NN (AP-01..AP-49 — v1.7.0 added AP-21..31 localization + async-safety; v1.8.0 added AP-32..40 devDeps-prod-crash/type-escape/i18n-routing/cosmetic-privacy/OG-SEO-drift/half-shipped/sensitive-subject/admin-recovery; v1.9.0 added AP-41..49 fail-open-verify/multi-tenant-secret-coupling/rotate-without-revoke/test-against-prod/CSP-self-defeat/audit-log-oracle/open-redirect/SVG-upload-XSS/timezone-hydration) + classic (IDOR, BOLA, N+1, RLS asymmetry, dead code, etc.) |
...
<td>Import core contract into CLAUDE.md → 23 governance + 15 sector + 15 rule packs active per session</td>
</tr>
<tr>
...
<sub>Authoritative as of Ulak OS <b>v1.9.0</b> · Build metadata: <a href="./prompts/pack.json"><code>prompts/pack.json</code></a> · Core contract: <a href="./prompts/core/ulak-os-core-contract-2.0.0.md"><code>ulak-os-core-contract-2.0.0.md</code></a></sub>
