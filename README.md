...
| **Anti-desen** | ~100 | 31 AP-NN (AP-01..AP-31 — v2.0.0'da AP-21..23 lokalleştirme + AP-24..31 async-safety/spec-drift/zombie-router/AI-content/admin-lockout/cache-race katmanı eklendi) + klasik (IDOR, BOLA, N+1, RLS asimetrisi, ölü kod vb.) |
